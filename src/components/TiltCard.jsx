...
const TiltCard = ({ children, className = "", color = "blue" }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        // Update CSS variables directly for spotlight - much more performant than React state
    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    opacity,
                    background: `radial-gradient(600px circle at var(--mouse-x, 0px) var(--mouse-y, 0px), rgba(${rgb}, 0.15), transparent 40%)`,
                }}
            />
